" let g:sqitch_cmd = 'sqitch --db-name bigspring_local '
...
"   nnoremap <buffer> t    :echo GetSqitchChangeAtCurrentLine()<CR>

"   nnoremap <silent> <buffer> <CR> :call OpenAllFilesForSqitchChangeAtCurrentLine()<CR>
"   nnoremap <silent> <buffer> o    :echo "TODO: Add a new change"<CR>
